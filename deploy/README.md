...
`Dockerfile.backend` uses a CUDA runtime placeholder image and installs the FastAPI backend requirements. For production IDM-VTON inference, adjust the CUDA/PyTorch base image to match the RunPod environment and mount:
