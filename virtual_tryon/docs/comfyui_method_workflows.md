...
| `garment_top` | image | upper/full outfit/Klein | Upper-body garment reference. |
| `garment_bottom` | image | lower/full outfit/Klein | Lower-body garment reference. |
...
| `category` | string | all methods | `upper_body`, `lower_body`, `dress`, `full_outfit`, or `accessory`. |
