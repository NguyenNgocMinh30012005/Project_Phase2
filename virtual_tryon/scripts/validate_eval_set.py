...
VALID_CATEGORIES = {"upper_body", "lower_body", "dress", "full_outfit"}
...
def validate_sample(sample_dir: Path) -> tuple[EvalSample | None, list[str]]:
    ...
    if category == "upper_body" and garment_top is None:
        errors.append("upper_body sample requires garment_top image")
    if category == "lower_body" and garment_bottom is None:
        errors.append("lower_body sample requires garment_bottom image")
